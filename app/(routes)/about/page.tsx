        ...
        <div className="max-w-7xl text-center flex flex-col gap-6 z-40">
          ...
          <Reveal>
            <p className="text-xl text-[#E4D9FF] max-w-4xl">
              ...
              isso que estamos empenhados em fornecer a você as melhores
              práticas e soluções inovadoras para tornar sua jornada mais
          ...
          <div className="flex flex-col gap-6">
            ...
            <Reveal>
              <p className="text-xl text-[#E4D9FF]">
                ...
                eficazes que qualquer pessoa pode adotar, independentemente de
                seu nível de experiência. Quer você seja um estudante que busca
            ...
            <ol className="text-xl text-[#E4D9FF] flex flex-col gap-4">
              <Reveal>
                <li>
              ...
              <Reveal>
                <li>
                  ...
                  : Publicamos regularmente artigos, guias e dicas úteis para
                  ajudar você a aprender a arte da organização e produtividade
                  pessoal.
                </li>
              </Reveal>
              <Reveal>
                <li>
                  ...
                  responder às suas perguntas, fornecer orientações
                  personalizadas e oferecer suporte quando você mais precisar.
                </li>
              </Reveal>
              <Reveal>
                <li>
